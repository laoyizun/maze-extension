...
//================== 拓展玩家 ==================
    ...
    export function getCurPlayer(){
        return <Player>Bullet.curPlayer
    }
    ...
    sprites.onDestroyed(SpriteKind.PlayerWeapon, function(sprite: Sprite) {
        if(getCurPlayer().curWeapon == sprite){
            weaponDestroy(getCurPlayer())
        }
    })
}
